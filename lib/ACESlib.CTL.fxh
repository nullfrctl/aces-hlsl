...
#define FLT_POS_INF (asfloat(0x7FFFFFFF))
#define FLT_NEG_INF (asfloat(0xFFFFFFFF))

#define HALF_MAX (+65504.)
#define HALF_MIN (asfloat(0x38800000))
#define HALF_POS_INF (+65536.)
#define HALF_NEG_INF (-65536.)
