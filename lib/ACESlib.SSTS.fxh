...
#include "ACESlib.Transform_Common.fxh"
...
)
{
  ...
  P.Mid = MID_PT;
  P.Max = MAX_PT;
  P.coefsLow = { cLow[0], cLow[1], cLow[2], cLow[3], cLow[4], cLow[4] };
  P.coefsHigh = { cHigh[0], cHigh[1], cHigh[2], cHigh[3], cHigh[4], cHigh[4] };

  return P;
}

TsParams init_TsParams( float minLum, float maxLum)
{
  return init_TsParams( minLum, maxLum, 0.0);
}
